...
class DrivingEnv(gym.Env):
    ...
    def render(self):
        ...
        # Draw car
        pygame.draw.rect(self.screen, (255, 0, 0), (self.car_pos[0] - self.car_width // 2, self.car_pos[1], self.car_width, self.car_height))

        # Draw obstacles
        for obstacle in self.obstacles:
            pygame.draw.rect(self.screen, (0, 0, 255), (obstacle[0] - self.obstacle_width // 2, obstacle[1], self.obstacle_width, self.obstacle_height))
